...
<?php
  ...
  if (isset($_SESSION["formulario"]) ){
    ...
    $formulario["compras"]=$_REQUEST["compras"];
    ...
    if (!empty($formulario["compras"]) && !preg_match($regex_int,$formulario["compras"])) 
      Header("Location: partidosbrawl_form.php");
    ...
    if ($formulario['compras'] == '') $formulario['compras'] = null;
    ...
    if ($formulario['liga'] == '') $formulario['liga'] = null;
        ...
        $bdid = "insert";
      if ($bdid == "insert")
        insertarPartidoCSGO($conexion, $formulario["resultado"], $formulario["tipo"], $fechadate, $formulario["jugadores"], $formulario["liga"], $formulario["mapa"], $formulario["puntuacion"], $formulario["compras"]);
      else
        actualizarPartidoCSGO($conexion, $bdid,  $formulario["resultado"], $formulario["tipo"], $fechadate, $formulario["jugadores"], $formulario["liga"], $formulario["mapa"], $formulario["puntuacion"], $formulario["compras"]);
      cerrarConexionBD($conexion);
      Header("Location: PartidosCSGO.php"); 
    }
  
  else Header("Location: partidoscsgo_form.php");
?>
