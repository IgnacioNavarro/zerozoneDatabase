...
<body>
    ...
    <div class="searchtools">
        ...
        <div class="Busqueda-plantilla">
            <input type="text" id="searchBar" placeholder="Buscar en la plantilla de FIFA" onkeyup="search()">
        </div>
        ...
        <table class="center search">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="JugadorFIFA.php" style="text-decoration: none; color: black;"><?php echo $form["nick"] ?></a></td>
