...
<head>
	...
	<title>ZEROZONE: REGISTRO DE ESTADÍSTICAS DE CLASH ROYALE</title>
</head>
...
<body>
			...
			<ul>
				...
				<li class="dropdown"><a class="dropdownbutton main">Juegos</a>
					<div class="dropdown-content">
						...
						<a class="clash-bar main" href="ClashRoyale.php">Clash royale</a>
	...
	<form action="estadisticas_clash_validation.php" method="POST">
		<div>
		...
		<div class="form">
			...
			<label for="partidasmazo">Partidas por mazo: </label>
			<input type="text" id="partidasmazo" name="partidasmazo" pattern="<?php echo $regex_wr ?>" value="<?php echo $formulario["partidasmazo"] ?>">
			<span class="error" id="ERRpartidasmazo"></span>


			<label for="wrmazo">Winrate por mazo: </label>
			<input type="text" id="wrmazo" name="wrmazo" pattern="<?php echo $regex_wr ?>" value="<?php echo $formulario["wrmazo"] ?>">
			<span class="error" id="ERRwrmazo"></span>


			<label for="hechizos">Hechizos usados: </label>
			<input type="text" id="hechizos" name="hechizos" pattern="<?php echo $regex_int ?>" value="<?php echo $formulario["hechizos"] ?>">
			<span class="error" id="ERRhechizos"></span>
		...
		<script>
			...
			function validate() {
				...
				Boolean test_partidas = textValidation(regex_wr, "partidasmazo", 2);
				Boolean test_wrmazo = textValidation(regex_wr, "wrmazo", 2);
				Boolean test_hechizos = textValidation(regex_int, "hechizos", 1);
				if (test_fecha && test_horas && test_wr && test_partidas && test_wrmazo && test_hechizos)
