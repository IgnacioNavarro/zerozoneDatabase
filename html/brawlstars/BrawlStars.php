...
<body>
    ...
    <div style="text-align: center;">
        <img id="brawlstarslogo" src="../images/Brawl Stars Logo CMYK.png">
    </div>
    <div class="button-container">
        <div class="row-button">
            <a class="button-juego" href="EquiposBrawl.php">EQUIPOS</a>
            <a class="button-juego" href="PlantillaBS.php">PLANTILLA</a>
        </div>
        <div class="row-button">
            <a class="button-juego" href="PartidosBS.php">PARTIDOS</a>
            <a class="button-juego" href="LigasBS.php">LIGAS</a>
        </div>
    </div>
