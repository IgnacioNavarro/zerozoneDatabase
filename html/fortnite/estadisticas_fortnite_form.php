...
<head>
	...
	<title>ZEROZONE: REGISTRO DE ESTADÍSTICAS DE FORTNITE</title>
</head>
...
<body>
			...
			<ul>
				...
				<li class="dropdown"><a class="dropdownbutton main">Juegos</a>
					<div class="dropdown-content">
						...
						<a class="fortnite-bar main" href="Fortnite.php">Fortnite</a>
	...
	<form action="estadisticas_fortnite_validation.php" method="POST">
		<div>
		...
		<div class="form">
			...
			<label for="streaming">Horas de streaming: </label>
			<input type="text" id="streaming" name="streaming" pattern="<?php echo $regex_int ?>" value="<?php echo $formulario["streaming"] ?>">
			<span class="error" id="ERRstreaming"></span>
			<br>
			...
			<input type="submit" id="submitEstadisticasFortnite" name="submitEstadisticasFortnite" value="Registrar estadisticas">
		</div>
		<script>
			...
			function validate() {
				...
				Boolean test_streaming = textValidation(regex_wr, "streaming", 1);
				Boolean test_kda = textValidation(regex_wr, "kda", 2);
				if (test_fecha && test_horas && test_streaming && test_kda)
					document.getElementById("submitEstadisticasFortnite").disabled = "";
				else
					document.getElementById("submitEstadisticasFortnite").disabled = "disabled";
			}
