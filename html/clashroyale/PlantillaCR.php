...
<body>
    ...
    <div class="searchtools">
        ...
        <div class="Busqueda-plantilla">
            <input type="text" id="searchBar" placeholder="Buscar en la plantilla de Clash Royale" onkeyup="search()">
        </div>
    </div>
    <div id="partidos">
        <table class="center search">
            ...
            $data = listadoClashRoyale($conexion);
            foreach ($data as $row) :
            ...
            ?>
                <tr>
                    ...
                    <td><a href="JugadorCR.php" style="text-decoration: none; color: black;"><?php echo $form["nick"] ?></a></td>
