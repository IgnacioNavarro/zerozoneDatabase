...
<body>
    ...
    <div style="text-align: center;">
        <img id="lollogo" src="../images/lol-logo.png">
    </div>
    <div class="button-container">
        <div class="row-button">
            <a class="button-juego" href="EquiposLOL.php">EQUIPOS</a>
            <a class="button-juego" href="PlantillaLOL.php">PLANTILLA</a>
        </div>
        <div class="row-button">
            <a class="button-juego" href="PartidosLOL.php">PARTIDOS</a>
            <a class="button-juego" href="LigasLOL.php">LIGAS</a>
        </div>
    </div>
