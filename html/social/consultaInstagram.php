...
<body>
    ...
    <div id="rrssHeader">
        <h1>INSTAGRAM <img src="../images/instagramOriginal.png"></h1>
        <a href="https://www.instagram.com/zerozoneclub" target="_blank" id="rrssLink">www.instagram.com/zerozoneclub</a>
        <form method="POST">
            <label for="date"><b>Datos desde el dia</b></label>
            <input type="date" id="date" name="date">
        </form>
        <a href="instagram_form.php"><img src="../images/masIcon.png"></a>
    </div>
    ...
    <div id="divTablaSocial">
        <table class="center" id="tablaSocial">
            ...
            $data = listadoInstagram($conexion);
            foreach ($data as $row) :
                    ...
                    <td>
                        <div style="display: flex; flex-direction: row; padding-left: 30px; padding-top: 5px;">
                            <form method="POST" action="../accion_editar.php">
                                ...
                                <input name="destino" type="hidden" value="social/instagram_form.php">
                            ...
                            <form method="POST" action="../accion_borrar.php">
                                ...
                                <input name="destino" type="hidden" value="social/consultaInstagram.php">
