...
<body>
    ...
    <div class="searchtools">
        ...
        <div class="Busqueda-plantilla">
            <input type="text" id="searchBar" placeholder="Buscar en la plantilla de CS:GO" onkeyup="search()">
        </div>
    </div>
    <div id="partidos">
        <table class="center search">
            ...
            <?php
                ...
                <tr>
                    ...
                    <td><a href="JugadorCS.php" style="text-decoration: none; color: black;"><?php echo $form["nick"]?></a></td>
