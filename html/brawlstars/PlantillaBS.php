...
<body>
    ...
    <div class="searchtools">
        ...
        <div class="Busqueda-plantilla">
            <input type="text" id="searchBar" placeholder="Buscar en la plantilla de Brawl Stars" onkeyup="search()">
        </div>
    </div>
    <div id="partidos">
        <table class="center search">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="JugadorBS.php" style="text-decoration: none; color: black;"><?php echo $form["nick"] ?></a></td>
