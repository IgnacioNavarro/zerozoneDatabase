...
<body>
    ...
    <div style="text-align: center;">
        <img id="fifalogo" src="../images/Fifa-ea.png">
    </div>
    <div class="button-container">
        <div class="row-button">
            <a class="button-juego" href="EquiposFIFA.php">EQUIPOS</a>
            <a class="button-juego" href="PlantillaFIFA.php">PLANTILLA</a>
        </div>
        <div class="row-button">
            <a class="button-juego" href="PartidosFIFA.php">PARTIDOS</a>
            <a class="button-juego" href="LigasFIFA.php">LIGAS</a>
        </div>
    </div>
