...
<body>
            ...
            <ul>
                ...
                <li class="dropdown"><a class="dropdownbutton main" href="javascript:void(0)">Juegos</a>
                    <div class="dropdown-content">
                        ...
                        <a class="csgo-bar main" href="../csgo/CSGO.php">CS:GO</a>
    ...
    <div style="text-align: center;">
        <img id="csgologo" src="../images/csgo-logo.png">
    </div>
    <div class="button-container">
        <div class="row-button">
            <a class="button-juego" href="EquiposCS.php">EQUIPOS</a>
            <a class="button-juego" href="PlantillaCSGO.php">PLANTILLA</a>
        </div>
        <div class="row-button">
            <a class="button-juego" href="PartidosCSGO.php">PARTIDOS</a>
            <a class="button-juego" href="LigasCSGO.php">LIGAS</a>
        </div>
    </div>
