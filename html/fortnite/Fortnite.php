...
<body>
            ...
            <ul>
                ...
                <li class="dropdown"><a class="dropdownbutton main" href="javascript:void(0)">Juegos</a>
                    <div class="dropdown-content">
                        ...
                        <a class="fortnite-bar main" href="../fortnite/Fortnite.php">Fortnite</a>
    ...
    <div style="text-align: center;">
        <img id="fortnitelogo" src="../images/fortnite-logo.png">
    </div>
    <div class="button-container">
        <div class="row-button">
            <a class="button-juego" href="EquiposFortnite.php">EQUIPOS</a>
            <a class="button-juego" href="PlantillaFORTNITE.php">PLANTILLA</a>
        </div>
        <div class="row-button">
            <a class="button-juego" href="PartidosFORTNITE.php">PARTIDOS</a>
            <a class="button-juego" href="LigasFORTNITE.php">LIGAS</a>
        </div>
    </div>
